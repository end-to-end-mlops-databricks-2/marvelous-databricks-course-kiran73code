...
from yellow_taxi.serving.feature_serving import FeatureServing
...
feature_table_name = f"{catalog_name}.{schema_name}.yellow_taxi_preds"
feature_spec_name = f"{catalog_name}.{schema_name}.return_predictions"
endpoint_name = "yellow-taxi-feature-serving"
