...
class BasicModel:
    ...
    def register_model(self):
        ...
        registered_model = mlflow.register_model(
            ...
            name=f"{self.catalog_name}.{self.schema_name}.yellow_taxi_model_basic",
            tags=self.tags
        )
    ...
    def load_latest_model_and_predict(self, input_data: pd.DataFrame):
        ...
        model_uri = f"models:/{self.catalog_name}.{self.schema_name}.yellow_taxi_model_basic@latest-model"
